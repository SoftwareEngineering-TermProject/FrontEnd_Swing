...
public class BlockButton extends JButton {
    ...
    public BlockButton(Color unClickBackground, Color clickBackground, Color foreground, String txt) {
        ...
        int h = (int) dimension.getHeight() + paddingHeight * 3+ shadow;
    ...
    public void paintComponent(Graphics g) {
        ...
        int h = (int) dimension.getHeight() - shadow;

        g2.setColor(clickBackground);
        g2.fillRoundRect(0, 5, w, h, 35, 35);
        ...
        g2.drawString(getText(), (w - rectangle.width) / 2, (h - rectangle.height + shadow) / 2 + fontMetrics.getAscent());
    }
}